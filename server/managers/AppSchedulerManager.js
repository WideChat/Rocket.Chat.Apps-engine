...
class AppSchedulerManager {
    ...
    scheduleOnce(job, appId) {
        return __awaiter(this, void 0, void 0, function* () {
            this.bridge.scheduleOnce(Object.assign({}, job, { id: createProcessorId(job.id, appId) }), appId);
        });
    }
    scheduleRecurring(job, appId) {
        return __awaiter(this, void 0, void 0, function* () {
            this.bridge.scheduleRecurring(Object.assign({}, job, { id: createProcessorId(job.id, appId) }), appId);
        });
    }
